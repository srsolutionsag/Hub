...
/**
 * Class hubAbstractTableGUI
 *
 * copy of https://github.com/studer-raimann/ActiveRecord/blob/master/class.srModelObjectTableGUI.php
 *
 * @author  Theodor Truffer <tt@studer-raimann.ch>
 */
abstract class hubAbstractTableGUI extends ilTable2GUI {
	 ...
	 * @description  set custom metjosd for filtering and resetting ($this->setResetCommand('resetFilter'); and
	...
	/**
	 * @return bool
	 * @description returns false, if dynamic template is needed, otherwise implement your own template by $this->setRowTemplate($a_template,
	 *              $a_template_dir = "")
	 */
